    ...
    <div>
      <div class="visax">
        ...
        <div class="lg:pb-28 lg:pt-80 pt-64 pb-16 max-w-4xl px-6 lg:px-20 flex flex-col m-auto justify-center items-center">
          <div class="font-semibold text-2xl lg:text-5xl bn">Visa Services</div>
      ...
      <div class="lg:px-20 px-6 pt-16 pb-8 lg:py-16">
        <div>
          <div class="lg:text-4xl text-xl font-bold pb-2 leading-8 lg:leading-10 lg:py-3">
            VISA <span class="text-red-700">SERVICES</span>
          </div>
          <div class="lg:py-1 pt-2 pb-0 leading-7 opacity-95">
            Planning to visit another country for tourism, visiting someone,
            study or work, we offer visa consultation and preparing all visas’
            requirements to all countries like the U.S, Canada, Australia, New
            Zealand, and Europe.
          </div>
          <div class="lg:pb-3 lg:pt-3 pt-2 pb-0 italic opacity-90">
            NOTE: You can read all of the visa services in details by clicking
            on the links in the left side of this page , regarding the following
            visa categories
          </div>
            ...
            <div class="py-2">
              <div class=" lg:py-2 py-2">
                <Link
                  ...
                  class="font-bold lg:text-xl py-2 underline hover:text-red-700"
                >
                  1. Tourist Visa
                </Link>
                <div>
                  If you are planning to visit a country for tourism purposes,
              ...
              <div class=" lg:py-3 py-2">
                ...
                <div>
                  If you are planning to visit someone, a friend or a family
                  member you will need a visitor visa.
                </div>
              </div>
              <div class=" lg:py-3 py-2">
                <Link
                ...
                <div>
                  If you are traveling for business, meeting clients or
                  providers you will need a business visa.
                </div>
              </div>
              <div class=" lg:py-3 py-2">
                <Link
                ...
                <div>
                  If you are planning to study abroad, you will need a student
                  visa
                </div>
              </div>
              <div class=" lg:py-3 py-2">
                ...
                <div>
                  If you are planning to work in another country you will need a
                  work visa
                </div>
              </div>
            </div>
